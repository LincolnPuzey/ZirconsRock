...
class StartPage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        test_upb_button = Button(contentFrame, text="Test UPb", command=self.test_upb)
        test_te_button = Button(contentFrame, text="Test TE", command=self.test_te)
    ...
    def test_upb(self):
        UPb.UPb(defaults.CONTROL_STANDARDS, defaults.NORMALISING_STANDARDS, defaults.UPB_INPUT_FILEPATHS, defaults.UPB_OUTPUT_FILEPATH)
        self.controller.isUpb = True
        self.controller.frames["UPbInputOutputPage"].output_filepath.set(defaults.UPB_OUTPUT_FILEPATH)
        self.controller.frames["UPbInputOutputPage"].output_dir.set(defaults.OUTPUT_DIR)
        self.controller.frames["UPbInputOutputPage"].output_filename.set(defaults.UPB_OUTPUT_FILEPATH)

        self.controller.frames["FilterStandardsPage"].footerFrame.goToNextPage()

    def test_te(self):
        TE.te(defaults.TE_INPUT_FILEPATHS, defaults.TE_OUTPUT_FILEPATH, defaults.CHONDRITE_FILE)
        self.controller.isUpb = False
        self.controller.frames["TEInputOutputPage"].output_filepath.set(defaults.TE_OUTPUT_FILEPATH)
        self.controller.frames["TEInputOutputPage"].output_dir.set(defaults.OUTPUT_DIR)
        self.controller.frames["TEInputOutputPage"].output_filename.set(defaults.TE_OUTPUT_FILEPATH)
